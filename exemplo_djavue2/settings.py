"""
Django settings for exemplo_djavue2 project.
...
ROOT_URLCONF = 'exemplo_djavue2.urls'
...
WSGI_APPLICATION = 'exemplo_djavue2.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './exemplo_djavue2.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
